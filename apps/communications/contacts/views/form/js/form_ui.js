...
(function(exports) {
  ...
  function addListeners() {
    ...
    formHeader.addEventListener('action', function() {
 ...
 /**
  ...
  var insertField = function insertField(type, object, isUserInteraction) {
  ...
  var getName = function createName(contact) {
    var givenName = '', familyName = '';
  ...
  var emptyForm = function emptyForm() {
    if (!cachedInputs) {
      cachedInputs = contactForm.querySelectorAll('input[data-field]:not(.invalid)');
    }
  ...
  var createDeleteButton = function createDeleteButton(selector, type) {
  ...
  var appendRemovePhotoButton = function cf_addRemIconPhoto() {
  ...
  function removeOrUpdatePhoto() {
    LazyLoader.load(
      ...
      function() {
        ...
        prompt.addToList({id: 'change-photo'}, PhotoPicker.pick.bind(null, appendPhoto));
